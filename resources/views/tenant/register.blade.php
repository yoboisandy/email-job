            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('tenant.register.store') }}">
                        ...
                        <div class="row mb-3">
                            <label for="store" class="col-md-4 col-form-label text-md-end">{{ __('Store Name') }}</label>

                            <div class="col-md-6">
                                <input id="store" type="text" class="form-control @error('store') is-invalid @enderror" name="store" value="{{ old('store') }}"  autocomplete="store" autofocus>
